...
function addPlatforms() {
  ...
  platforms.create(-80, 200, 'platform2');
...
function createBadge() {
  ...
  var badge = badges.create(575, 150, 'badge');
...
function itemHandler(player, item) {
  ...
  if (item.key === 'star'){
    platforms.create(300,210, 'platform2')
    platforms.setAll('body.immovable', true);
    createItem(325, 160, 'coin');
  }
}
